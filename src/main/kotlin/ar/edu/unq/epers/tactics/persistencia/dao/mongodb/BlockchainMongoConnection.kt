 ...
 *
 */
class BlockchainMongoConnection {
    ...
    init {
        ...
        val uri = System.getenv().getOrDefault("MONGO_URI", "mongodb://root:root@localhost:27017")
        val database = System.getenv().getOrDefault("MONGO_DB", "epers_blockchain")
