...
class FightControllerRest(private val peleaService: PeleaService) {
    ...
    // Cambio el nombre de la variables del servicio de acuerdo al enunciado - LM
    @PostMapping("/{partyId}/finish")
    fun finish(@PathVariable partyId: Long):StatusResponse  {
    ...
    fun receiveAbility(@PathVariable fightId: Long, @RequestBody request:ReceiveAbilityRequest):AventureroDTO {
        // Cambio la llamada del servicio de acuerdo al enunciado - LM
